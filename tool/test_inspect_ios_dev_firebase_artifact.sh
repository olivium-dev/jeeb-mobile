...
SYNTHETIC_CLIENT_ID='313705546061-synthetic.apps.googleusercontent.com'
SYNTHETIC_REVERSED_ID='com.googleusercontent.apps.313705546061-synthetic'
...
/usr/libexec/PlistBuddy -c "Set :API_KEY ${SYNTHETIC_API_KEY}" \
  "${firebase_plist}"
/usr/libexec/PlistBuddy -c 'Set :PROJECT_ID jeeb-development-msi' "${firebase_plist}"
/usr/libexec/PlistBuddy -c 'Set :GCM_SENDER_ID 313705546061' \
  "${firebase_plist}"
/usr/libexec/PlistBuddy -c 'Set :BUNDLE_ID app.jeeb.jeebMobile.dev' \
  "${firebase_plist}"
/usr/libexec/PlistBuddy -c \
  'Set :GOOGLE_APP_ID 1:313705546061:ios:800ef6ec4bf51312b6f704' \
  "${firebase_plist}"
...
wrong_app() {
  /usr/libexec/PlistBuddy -c \
    'Set :GOOGLE_APP_ID 1:313705546061:ios:aaaaaaaaaaaaaaaa' \
    "$1/GoogleService-Info.plist"
}

staging_project() {
  /usr/libexec/PlistBuddy -c 'Set :PROJECT_ID jeeb-5a293' \
    "$1/GoogleService-Info.plist"
...
expect_failure retired-staging-project staging_project
