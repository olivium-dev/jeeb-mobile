...
**Applied locally in the 2026-09-06 review-fix wave:** interpolation repaired, exact-value matcher regression added, and nonempty declaration-scan assertion added. The repaired scan measured 26 existing uncovered identifiers, so the honest initial ceiling is 26. This does not implement A1–A5, A7, or the ChatTab deletion; those remain planned. The 26-site list below is coverage debt, not 26 fixed cases.
