...
void main() {
  ...
  group('ObsScreenEvent', () {
    test(
      'payload carries action/route/name/params; prev omitted when null',
      () {
        final event = ObsScreenEvent(
          id: '1-screen',
          sessionId: 's-1',
  ...
  group('ObsNotificationEvent', () {
    test(
      'payload carries channel/mode/messageId/category + optional fields',
      () {
  ...
  group('ObsInteractionEvent', () {
    test('payload carries gesture and target but never tap coordinates', () {
