...
void main() {
  ...
  testWidgets(
    ...
    // Cold start: no token yet → gate forces /register (phone-OTP) once the
    // first refresh resolves (DEFECT-3: phone-OTP is the auth that works
    // against the live gateway; email `/login` 401s there).
