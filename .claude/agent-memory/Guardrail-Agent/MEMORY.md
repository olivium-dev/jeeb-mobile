...
- [Owner ruling: MSI only, no staging](owner-ruling-msi-only-no-staging.md) — 2026-07-26 blocking rule; escalate rather than reach for staging; config files lie, read the runtime env; how to prove MSI-only in evidence
