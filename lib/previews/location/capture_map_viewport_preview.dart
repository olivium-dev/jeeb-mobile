...
/// would use.
const double _thumbnailSide = 160;

/// A short strip: the tallest slot the content still fits at 1× text.
const double _shortStripHeight = Sizes.tenXLarge;
...
Widget captureMapViewportCaptureScreen() => _measured(
...
Widget captureMapViewportAddressFormBand() => _measured(
...
Widget captureMapViewportThumbnail() => _measured(
      ...
      const SizedBox(
        width: _thumbnailSide,
        height: _thumbnailSide,
        child: CaptureMapViewport(),
      ),
    );
...
Widget captureMapViewportShortStrip() => _measured(
      'Short strip: 390x96 slot',
      const SizedBox(
        width: _phoneWidth,
        height: _shortStripHeight,
        child: CaptureMapViewport(),
      ),
    );
