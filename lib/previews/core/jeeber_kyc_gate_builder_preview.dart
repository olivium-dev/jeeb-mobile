...
const Size _tabBox = Size(390, 280);
...
const Key jeeberKycGatePreviewBodyKey = Key('jeeber-kyc-gate-preview-body');
...
class _ResolvedDestination extends StatelessWidget {
  const _ResolvedDestination({required this.gate, required this.source});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      key: jeeberKycGatePreviewBodyKey,
...
Widget _live(KycGateway gateway) => _hosted(
...
class _StalledKycGateway extends FakeKycGateway {
  @override
