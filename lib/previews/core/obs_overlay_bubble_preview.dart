...
import '../../core/observability/session_trace/presentation/widgets/obs_overlay_bubble.dart';
...
const Size _phoneViewport = Size(390, 360);
...
const Size _bottomEdgeViewport = Size(390, 200);

/// The bottom-edge stage plus the same caption headroom.
const Size _bottomEdgeCanvas = Size(390, 310);
...
final ObsOverlayController _inertController = ObsOverlayController();
            ...
            child: SizedBox.fromSize(
              ...
              child: Stack(
                ...
                children: <Widget>[
                  ...
                  ObsOverlayBubble(controller: _inertController),
                ],
              ),
            ),
          ),
...
class _FakeScreen extends StatelessWidget {
  const _FakeScreen({required this.title, required this.rows, this.bottom});
...
class _NavDestination extends StatelessWidget {
  const _NavDestination({required this.icon, required this.label, super.key});
...
class _FakePrimaryCta extends StatelessWidget {
  const _FakePrimaryCta();
...
class _FakeGestureBand extends StatelessWidget {
  const _FakeGestureBand();
