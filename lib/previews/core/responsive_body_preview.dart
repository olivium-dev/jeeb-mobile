...
class _ContentBlock extends StatelessWidget {
  const _ContentBlock({required this.label, this.fillWidth = true});
...
Widget _hosted({
  ...
  bool fillWidth = true,
    ...
    _Viewport(
      width: width,
      child: _ContentBlock(label: label, fillWidth: fillWidth),
    );
...
Widget responsiveBodyTabletPortrait() => _hosted(
      width: _tabletWidth,
...
Widget responsiveBodyJustUnderWide() => _hosted(
      width: _justUnderWide,
...
Widget responsiveBodyAtWideBreakpoint() => _hosted(
      width: _atWide,
...
Widget responsiveBodyDesktop() => _hosted(
      width: _desktopWidth,
...
Widget responsiveBodyIntrinsicChild() => _hosted(
      width: _desktopWidth,
