...
import '../../features/rating/presentation/widgets/feedback_header.dart';
...
const double _screenGutter = Spacing.large;
...
///    otherwise — see the library doc) and the block scrolls when it outgrows
...
Widget _hosted(Widget child, {double width = _phoneWidth, String? caption}) =>
    Align(
      ...
      Builder(
        builder: (BuildContext context) {
          ...
          return Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: <Widget>[
              const FeedbackAvatar(name: _rateeName),
              const SizedBox(height: Spacing.xLarge),
              const FeedbackHeader(isClient: true),
              const SizedBox(height: Spacing.xLarge),
              Text(
                AppLocalizations.of(context).feedbackRateName(_rateeName),
                textAlign: TextAlign.center,
