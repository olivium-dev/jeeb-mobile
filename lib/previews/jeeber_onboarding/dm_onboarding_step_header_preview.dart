/// Widget previews for [DmOnboardingStepHeader] — run with
...
const Size _shortCopyBox = Size(390, 300);
const Size _longCopyBox = Size(390, 460);
const Size _compactBox = Size(320, 460);
...
Widget _hosted({
  required _Copy title,
  required _Copy subtitle,
