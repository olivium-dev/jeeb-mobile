...
import '../../features/customer_profile/presentation/widgets/customer_profile_rating.dart';
...
/// reason `jeeb_verified_badge_preview.dart` pins it: the canvas honours `size`,
...
const double _smallIdentityWidth = 180;
...
const Size _chipBox = Size(390, 96);
