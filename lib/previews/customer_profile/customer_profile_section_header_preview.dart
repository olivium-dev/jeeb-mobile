...
import '../../features/customer_profile/presentation/widgets/customer_profile_section_header.dart';
...
/// observable at all.
Widget _stretched(Widget header) => Column(
...
Widget _hosted(String Function(AppLocalizations) title) => _stretched(
      Builder(
