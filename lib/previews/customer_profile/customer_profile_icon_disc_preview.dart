...
///   disc's own label. This follows
///   `lib/previews/chat/chat_composer_icon_button_preview.dart`.
...
///   way in Arabic. The two specimens at the bottom of this file exist for
...
import '../../features/customer_profile/presentation/widgets/customer_profile_icon_disc.dart';
...
const Size _discBox = Size(340, 150);
...
const List<IconData> _productionGlyphs = <IconData>[
...
Widget customerProfileIconDiscProductionSet() => _hosted(
  ...
  sample: Padding(
    ...
    child: Wrap(
      ...
      children: <Widget>[
        for (final IconData glyph in _productionGlyphs)
        ...
        child: const Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              _OnSecondaryContainerReference(icon: Icons.lock_outline),
            ],
          ),
        ),
      ),
...
/// change to `customer_profile_icon_disc.dart`.
class _OnSecondaryContainerReference extends StatelessWidget {
  const _OnSecondaryContainerReference({required this.icon});
