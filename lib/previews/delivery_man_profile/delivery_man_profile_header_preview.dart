...
import '../../features/delivery_man_profile/presentation/widgets/delivery_man_profile_header.dart';

/// Phone width, for the states whose details column stays one line per row:
/// 112 dp at 1x, 244 dp at 200% text.
const Size _headerBox = Size(390, 260);
...
const Size _phoneScreenBox = Size(390, 460);
