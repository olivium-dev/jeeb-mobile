...
import '../../features/delivery_man_profile/presentation/widgets/delivery_reviews_header.dart';
...
const Size _headerBox = Size(_phoneWidth, 130);
const Size _largeTextBox = Size(_phoneWidth, 300);
const Size _withListBox = Size(_phoneWidth, 420);
