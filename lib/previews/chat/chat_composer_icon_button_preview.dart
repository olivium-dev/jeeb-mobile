...
import '../../features/chat/presentation/widgets/chat_composer_icon_button.dart';
...
const Size _specimenBox = Size(340, 170);

/// The composer's live semantics ids, copied from `chat_composer.dart`.
const String _kAttachId = 'chat_detail_attach_button';
const String _kSendId = 'chat_detail_send_button';

/// Reserved id for the B-04 voice affordance, matching the attach/send naming.
const String _kVoiceId = 'chat_detail_voice_button';
