...
import '../../features/chat/presentation/widgets/chat_bubble_timestamp.dart';
import '../harness/jeeb_preview.dart';

/// Canvas box for one bubble plus its meta row.
const Size _bubbleBox = Size(390, 160);
...
class _Bubble extends StatelessWidget {
  const _Bubble({required this.child, this.filled = false, this.caption});
...
@JeebPreview(group: 'chat', name: 'Offer card footer · 12:34', size: _matrixBox, matrix: true)
Widget chatBubbleTimestampOfferFooter() =>
    _offerFooter(sentAt: DateTime(2026, 6, 1, 12, 34));
...
@JeebPreview(group: 'chat', name: 'Sender bubble · caller colour', size: _bubbleBox)
Widget chatBubbleTimestampSenderBubble() => _senderFooter(
...
@JeebPreview(group: 'chat', name: 'Sender bubble · default colour', size: _matrixBox, matrix: true)
Widget chatBubbleTimestampDefaultInkOnBubble() => _senderFooter(
...
@JeebPreview(group: 'chat', name: 'Ordering anchor · no clock', size: _bubbleBox)
Widget chatBubbleTimestampOrderingAnchor() => _offerFooter(
...
/// "12:00 AM".
@JeebPreview(group: 'chat', name: 'Epoch anchor drawn as 00:00', size: _bubbleBox)
Widget chatBubbleTimestampEpochDrawn() => _offerFooter(sentAt: DateTime(1970));
...
@JeebPreview(group: 'chat', name: 'UTC instant, not localized', size: _bubbleBox)
Widget chatBubbleTimestampUtcInstant() =>
    _offerFooter(sentAt: DateTime.utc(2026, 6, 11, 21, 5));
