...
const String _kArabicTranscript = 'كيلو بندورة من السوق';

/// Reused from the catalog's "Editing — text field open" fixture.
const String _kEditDraft = 'Two bags of rice';
...
Widget _hosted(TranscriptionState state) {
  return BlocProvider<TranscriptionCubit>(
    create: (_) => TranscriptionCubit(player: const NoopTranscriptAudioPlayer()),
