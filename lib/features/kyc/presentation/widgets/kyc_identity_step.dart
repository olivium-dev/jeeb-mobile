...
/// JM-040 `kyc-identity` — the single identity-capture screen o
...
/// A 120 × 76 landscape PNG in the ISO/IEC 7810 ID-1 proportion
...
/// A 60 × 76 portrait PNG — a face and shoulders on a warm grou
...
/// The real cubit over inert collaborators, parked on `seed`. N
...
/// Builds an identity-step state. Defaults describe a cold entr
...
/// Mounts the step over a cubit seeded with [seed]. The `ValueK
...
/// Cold entry: the jeeber has just landed on `kyc-identity` and
@JeebPreview(
  group: 'kyc',
...
/// The JEBV4-295 state: gov-ID done, number valid, ToS ticked —
@JeebPreview(
  group: 'kyc',
...
/// Everything captured, a contract-valid 12-digit national ID, 
@JeebPreview(
  group: 'kyc',
...
/// The BFF rejected the number itself: a field-scoped RFC-7807 
@JeebPreview(
  group: 'kyc',
...
/// Residency permit rejected on `id_type` — a live contract mis
@JeebPreview(
  group: 'kyc',
...
/// Content ceiling: a passport at the field's full 24-character
@JeebPreview(
  group: 'kyc',
