...
// Render tests: test/previews/location/gps_denied_state_preview_test.dart
// ===========================================================================
...
// from [_GpsDeniedStateSlot]'s `width` for WIDTH. Height is left to the canvas deliberately:
...
// not follow the text scaler (see [_GpsDeniedStateCaption]) so that the `EN 200% text`
