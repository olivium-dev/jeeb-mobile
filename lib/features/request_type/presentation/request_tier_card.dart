...
// Render tests: test/previews/request_type/request_tier_card_preview_test.dart
// ===========================================================================
...
/// Canvas boxes, in a 390 dp phone width. Inside [_requestTierCardPageInset]
/// that leaves the card its production 350 dp, so its copy wraps where the app
/// wraps it — not at the 800 dp a default test surface would give it.
///
