...
///
/// NOTE: super-login / super-login-plus entry points were removed from the
/// production app — they now live ONLY in the Dev Tool (lib/devtool). The
/// shared sheet/picker implementation under `super_login/` is retained because
/// the Dev Tool depends on it.
