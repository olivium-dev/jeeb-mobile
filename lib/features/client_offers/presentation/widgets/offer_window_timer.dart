...
// Render tests: test/previews/client_offers/offer_window_timer_preview_test.dart
// ===========================================================================
...
// is a small chip and every state looks fine; reviewed at
// [_offerWindowTimerContentWidth] you see the coloured band the client actually
// sees above the offer list. The width is pinned in the fixture rather than
// left to the canvas [Size] so the canvas and the render tests agree.
//
