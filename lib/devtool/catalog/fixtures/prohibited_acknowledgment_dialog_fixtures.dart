...
class FakeProhibitedAckRepository implements ProhibitedAcknowledgmentRepository {
...
class AckFailingProhibitedAckRepository
    implements ProhibitedAcknowledgmentRepository {
  AckFailingProhibitedAckRepository({this.failure = const ServerFailure(status: 503)});
  ...
  @override
  Future<void> acknowledge() async => throw failure;
...
class ProhibitedAckDialogHost extends StatefulWidget {
  ...
  @override
  State<ProhibitedAckDialogHost> createState() => _ProhibitedAckDialogHostState();
}
