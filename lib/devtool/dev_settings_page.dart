...
/// silently void every capture-class gate row in the batch — the verifier would
/// read "0 stream rows" off a capture that recorded nothing at all. Changing the
/// default belongs in the DevTool batch that owns `dev_base_url.dart`, with the
/// recorder path considered; it is outside MB1's member list.
